 ...
 * @author Poolsawat.a
 */
public class UiReportThaiMedicineAct extends javax.swing.JInternalFrame {
    ...
    String REPORT_NAME = "แพทย์แผนไทย";
    
    public UiReportThaiMedicineAct() {
        PROCESS = 0;
        initComponents();
        ...
        this.txtTitle1.setText(ThaiMedicineController.HEADER_DETAIL_ACT);
        this.loadCombo();
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("หน้าจอออกรายงาน กิจกรรมนวด ประคบสมุนไพร อบสมุนไพร และจ่ายยาสมุนไพร");
        ...
        txtTitle1.setText("รายงานรายละเอียดกิจกรรมนวด ประคบสมุนไพร อบสมุนไพร และจ่ายยาสมุนไพร");
        ...
        tabOpae74.add(jPanel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 0, 910, 530));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addContainerGap()
                .addComponent(tabOpae74, javax.swing.GroupLayout.DEFAULT_SIZE, 1164, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void btnThaiMedPathFileDesktopjButtonFolderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThaiMedPathFileDesktopjButtonFolderActionPerformed
       txtPathFileThaiMed.setText(FileUtil.getPathDesktop());
                                        ...
                                        public void run() {
                                            ...
                                            try {
                                                ...
                                                if (radioDetailThaiMed.isSelected()) { // รายละเอียด
                                                    programeStatus = new ThaiMedicineController().tmdDetailByHcode(setInputFormReport());

                                                    //action controller 
                                                    if (programeStatus.getProcessStatus()) {
                                                        JOptionPane.showMessageDialog(UiReportThaiMedicineAct.this,
                                                    ...
                                                    programeStatus = new ThaiMedicineController().tmdActSummary(setInputFormReport());
                                                    if (programeStatus.getProcessStatus()) {
                                                        JOptionPane.showMessageDialog(UiReportThaiMedicineAct.this,
                                                                programeStatus.getMessage(),
                                                                programeStatus.getTitle(),
                                    ...
                                    Thread thread = new Thread(new Runnable() {
                                        ...
                                        public void run() {
                                            ...
                                            try {
                                                ...
                                                wait.setTitle(ConstantMessage.MSG_PROGRAME_PROCESSSING);
                                                programeStatus = new ThaiMedicineController().tmd_genReportAllFunction(setInputFormReport());
                                                if (programeStatus.getProcessStatus()) {
                                                    JOptionPane.showMessageDialog(UiReportThaiMedicineAct.this,
                                                            ConstantMessage.MSG_REPORT_SUCCESS,
                                                            ConstantMessage.MSG_REPORT_COMPLETE, JOptionPane.INFORMATION_MESSAGE);
                                                    baseFunction.openDirectoryAutomatic(setInputFormReport().getPathFile());

                                                } else {
                                                    JOptionPane.showMessageDialog(UiReportThaiMedicineAct.this,
                                                            ConstantMessage.MSG_CAN_NOT_REPORT_ERROR,
                                                            ConstantMessage.MSG_PROCESS_FAILS,
                                                            JOptionPane.ERROR_MESSAGE);
                                                }
                                                wait.setVisible(false);
                                            } catch (Exception e) {
    ...
    private void radioDetailThaiMedItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_radioDetailThaiMedItemStateChanged
        if (evt.getStateChange() == ItemEvent.SELECTED) {
            txtTitle1.setText(ThaiMedicineController.HEADER_DETAIL_ACT);
        } else {
            txtTitle1.setText(ThaiMedicineController.HEADER_SUM_ACT);
        }
    ...
    public void loadCombo() {
        try {
            ...
            listStmpNoni = new UtilDao().getStmpDistinct("RPT_OPBKK_TMD_ACT", "STMP");
    ...
    public OppReport setInputFormReport() {
        ...
        report.setBudget_date(comboYearThaiMed.getSelectedItem().toString());
         report.setTmdServiceType(ConstantMessage.TMD_ACT);
        return report;
    }
