...
public class UiReportRefer extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        comboYearOpRefer.setFont(new java.awt.Font("TH SarabunPSK", 1, 18)); // NOI18N
        ...
        comboNumOpRefer.setFont(new java.awt.Font("TH SarabunPSK", 1, 18)); // NOI18N
        ...
        radioDetailOpRefer.setFont(new java.awt.Font("TH SarabunPSK", 1, 18)); // NOI18N
        radioDetailOpRefer.setSelected(true);
        radioDetailOpRefer.setText("รายงานแบบรายละเอียด");

        rGroupReferType.add(radioSumOpRefer);
        radioSumOpRefer.setFont(new java.awt.Font("TH SarabunPSK", 1, 18)); // NOI18N
        ...
        radioAllHospitalOpRefer.setFont(new java.awt.Font("TH SarabunPSK", 1, 18)); // NOI18N
        ...
        radioSingleHospitalOpRefer.setFont(new java.awt.Font("TH SarabunPSK", 1, 18)); // NOI18N
        ...
        btnReferChooseHospital.setFont(new java.awt.Font("TH SarabunPSK", 1, 18)); // NOI18N
        ...
        radioDeductOpRefer.setFont(new java.awt.Font("TH SarabunPSK", 1, 18)); // NOI18N
        ...
        radioPaymentOpRefer.setFont(new java.awt.Font("TH SarabunPSK", 1, 18)); // NOI18N
        ...
        radioAttributeSingleOpRefer.setFont(new java.awt.Font("TH SarabunPSK", 1, 18)); // NOI18N
        ...
        radioAttributeAllOpRefer.setFont(new java.awt.Font("TH SarabunPSK", 1, 18)); // NOI18N
        radioAttributeAllOpRefer.setText("เครือ");

        rGroupReferAttribute.add(radioAttributeOpRefer);
        radioAttributeOpRefer.setFont(new java.awt.Font("TH SarabunPSK", 1, 18)); // NOI18N
        ...
        rGroupReferSpecial.add(radio_special_refer_1);
        ...
        rGroupReferSpecial.add(radio_special_refer_all);
    ...
    private void btnReferPathFileDesktopjButtonFolderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnReferPathFileDesktopjButtonFolderActionPerformed
        txtPathFileOpRefer.setText(FileUtil.getPathDesktop());
                            ...
                            if (radioAllHospitalOpRefer.isSelected() || radioSingleHospitalOpRefer.isSelected() && listSelectHospital.size() > 0) {
                                if (radioDeductOpRefer.isSelected() || radioPaymentOpRefer.isSelected()) {
                                    if (radioAttributeAllOpRefer.isSelected() || radioAttributeSingleOpRefer.isSelected() || radioAttributeOpRefer.isSelected()) {
                                        ...
                                        JOptionPane.showMessageDialog(this,
                                                ConstantMessage.MSG_HOSPITAL_TYPE,
                                                ConstantMessage.MSG_SELECT_DATA,
                                                JOptionPane.ERROR_MESSAGE);
                                    }
                                } else {
                                    JOptionPane.showMessageDialog(this,
                                            ConstantMessage.MSG_REPORT_TYPE,
                                            ConstantMessage.MSG_SELECT_DATA,
                                            JOptionPane.ERROR_MESSAGE);
                                }
                            } else {
