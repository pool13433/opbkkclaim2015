 ...
 * @author Poolsawat.a
 */
public class UiCreateDataVajira extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        txt_global_budget = new javax.swing.JTextField();
        ...
        txt_global_budget.setFont(new java.awt.Font("TH SarabunPSK", 1, 18)); // NOI18N
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.LEADING, jPanel2Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(txt_global_budget, javax.swing.GroupLayout.PREFERRED_SIZE, 352, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel2)
                    .addComponent(txt_global_budget, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void btnCreateDataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateDataActionPerformed
        ...
        if (formValidateCreateData().isEmpty()) {
            ...
            Thread threadCheck = new Thread(new Runnable() {
                ...
                public void run() {
                    ...
                    staCheck = createStoreController.checkCreateDataDupicateGroupReportTypeVajira(setInputFormCreateData());
    ...
    private ObjCallStoreCreateData setInputFormCreateData() {
        ...
        objData.setGlobal_budget(Integer.parseInt(txt_global_budget.getText()));
        ...
        objData.setGroup_report_type(2);
        return objData;
    }

    private void loadComboCreateData() {
        String[] arrTable = ConstantVajira.PROCE_CREATE_TABLE_HC;
    ...
    private List<Integer> formValidateCreateData() {
        ...
        if (txt_global_budget.getText().isEmpty()) {
            error.add(1);
            lb_error6.setText("กรุณากรอกจำนวนเงินตั้งต้น");
        } else {
            try {
                Integer.parseInt(txt_global_budget.getText());
                lb_error6.setText("");
            } catch (NumberFormatException e) {
                error.add(1);
                lb_error6.setText("กรุณากรอกจำนวนเงินตั้งต้น เป็นตัวเลขเท่านั้น");
                e.printStackTrace();
            }
        }
        if (comboStmpNoMonth.getSelectedIndex() == 0) {
    ...
    private javax.swing.JTextField txt_global_budget;
