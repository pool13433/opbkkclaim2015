...
public class Vajira11535Dao {
    ...
    public List<HospitalService> getHospitalServiceWithHmain(OppReport report) {
        ...
        try {
            ...
            sql.append(" SELECT DISTINCT(HMAIN) as HMAIN,HMAIN_NAME FROM RPT_OPBKK_VAJIRA_HC11535 ");
    ...
    public List<ObjRptVajiraHc11535Detail> getListVajiraDetail(OppReport report) {
        List<ObjRptVajiraHc11535Detail> listData = null;
        ObjRptVajiraHc11535Detail objData = null;
        try {
            ...
            sql.append(" FROM RPT_OPBKK_VAJIRA_HC11535 hc");
            ...
            pstm = connection.prepareStatement(sql.toString());
            rs = pstm.executeQuery();
            listData = new ArrayList<ObjRptVajiraHc11535Detail>();
            while (rs.next()) {
                objData = new ObjRptVajiraHc11535Detail();
    ...
    public List<ObjRptVajiraHc11535Summary> getListVajiraSumGroupHmain(OppReport report) {
        List<ObjRptVajiraHc11535Summary> listData = null;
        ObjRptVajiraHc11535Summary objData = null;
        try {
            sql = new StringBuilder();
            ...
            sql.append(" FROM RPT_OPBKK_VAJIRA_HC11535");
            ...
            pstm = connection.prepareStatement(sql.toString());
            rs = pstm.executeQuery();
            listData = new ArrayList<ObjRptVajiraHc11535Summary>();
            while (rs.next()) {
                objData = new ObjRptVajiraHc11535Summary();
