...
public class DropReportDAO {
    ...
    public List<ObjPaymentResult> getListRptReportByTable(int indexTable) throws SQLException{
        List<ObjPaymentResult> listData = null;
        ObjPaymentResult objData = null;
        try {
            ...
            sql.append(" join ").append(ConstantVariable.TABLE_NAME[indexTable]).append(" r");
            sql.append(" on s.txid = r.txid");
            sql.append(" left join opbkk_stamp_payment st");
            sql.append(" on (r.stmp = st.stmp and st.optype = '").append(ConstantVariable.TABLE_ALIAS[indexTable]).append("') ");
    ...
    public int deleteRptReport(int indexTable,String stmp){
        ...
        try {
            sql = new StringBuilder();
            sql.append(" DELETE FROM ").append(ConstantVariable.TABLE_NAME[indexTable]);
