...
public class VajiraHCDao {
    ...
    public List<HospitalService> getHospitalService(OppReport report) {
        ...
        try {
            ...
            sql.append(" SELECT DISTINCT(HCODE) as HCODE,HCODENAME FROM RPT_OPBKK_VAJIRA_HC ");
    ...
    public List<ObjRptVajiraHcDetail> getListVajiraDetail(OppReport report) {
        List<ObjRptVajiraHcDetail> listData = null;
        ObjRptVajiraHcDetail objData = null;
        try {
            ...
            sql.append(" FROM RPT_OPBKK_VAJIRA_HC hc");
            ...
            pstm = connection.prepareStatement(sql.toString());
            rs = pstm.executeQuery();
            listData = new ArrayList<ObjRptVajiraHcDetail>();
            while (rs.next()) {
                objData = new ObjRptVajiraHcDetail();
    ...
    public List<ObjRptVajiraHcSummary> getListVajiraSumGroupHmain(OppReport report) {
        List<ObjRptVajiraHcSummary> listData = null;
        ObjRptVajiraHcSummary objData = null;
        try {
            sql = new StringBuilder();
            ...
            sql.append(" FROM RPT_OPBKK_VAJIRA_HC");
            ...
            pstm = connection.prepareStatement(sql.toString());
            rs = pstm.executeQuery();
            listData = new ArrayList<ObjRptVajiraHcSummary>();
            while (rs.next()) {
                objData = new ObjRptVajiraHcSummary();
    ...
    public List<HospitalService> getHospitalServiceWithHmain(OppReport report) {
        ...
        try {
            sql = new StringBuilder();
            sql.append(" SELECT DISTINCT(HMAIN) as HMAIN,HMAIN_NAME FROM RPT_OPBKK_VAJIRA_HC ");
            sql.append(" WHERE 1=1 ");
            if (!report.getYearMonth().equals("") && !report.getNo().equals("")) {
                sql.append(" AND STMP = '").append(report.getYearMonth()).append("-").append(report.getNo()).append("'");
            }
